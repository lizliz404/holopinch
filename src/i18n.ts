...
const en = {
  ...
  startShort: 'Camera…',
  loadingWasm: 'Fetching hand-tracker runtime…',
  loadingModel: 'Downloading hand landmarks…',
  loadingInit: 'Starting hand tracker…',
  loadingGeneric: 'Preparing hand tracker…',
  requestingCamera: 'Waiting for camera permission…',
  ...
  // shorten map values
  shortWasm: 'Runtime…',
  shortModel: 'Landmarks…',
  shortLoading: 'Starting…',
  shortCamera: 'Permission…',
...
const zh: Record<keyof typeof en, string> = {
  ...
  startShort: '摄像头…',
  loadingWasm: '正在获取手部追踪运行时…',
  loadingModel: '正在下载手部关键点模型…',
  loadingInit: '正在启动手部追踪…',
  loadingGeneric: '正在准备手部追踪…',
